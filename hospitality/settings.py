#django settings for Userena hospitality project.
DEBUG = True
...
#PROFILES_ROOT    = os.path.join(settings_dir, 'profiles')
#if '/profiles' not in ' '.join(sys.path):
#    sys.path.append(PROFILES_ROOT)
...
DATABASES = {
    'default': {
        ...
        'NAME': 'hospitality',                       # Or path to database file if using sqlite3.
        'USER': 'root',                       # Not used with sqlite3.
        'PASSWORD': 'p@$$w0rd_sql',                   # Not used with sqlite3.
...
#    'hospitality': {
#        'ENGINE': 'django.db.backends.mysql',  # Add 'postgresql_psycopg2', 'postgresql', 'mysql', 'sqlite3' or 'oracle'.
#        'NAME': 'antik_hospitality',                       # Or path to database file if using sqlite3.
#        'USER': 'root',                       # Not used with sqlite3.
#        'PASSWORD': 'n3tc1t1',                   # Not used with sqlite3.
#        'HOST': '172.24.0.12',                       # Set to empty string for localhost. Not used with sqlite3.
